...
def set_driver(driver_path, headless_flg):
    ...
    #Selenium WebDriverを使う場合自分でHTTPリクエストを作成して操作するということはなく、これらのAPIを扱うためのクライアントが用意されている
    return  webdriver.Chrome(executable_path=os.getcwd() + "/" + driver_path, options=options)
